...
import pandas as pd
import numpy as np
from chatcompletion import chat_completion

def GenerateDocx(Header_imgpath="D:\AI Automation\AI-Automation\data\KTB-Logo.jpg",
                project_name='เสนอคณะกรรมการขอทำ Project 10X ให้ประเทศไทยไม่เหมือนเดิมอีกต่อไป',
                team_name='AI Automation',
                first_topic='1.ตัวอย่างการจัดทำเอกสารลองดึงข้อมูลจากฐานข้อมูลและสร้างกราฟแสดงผล'):
    ...
    run_paragraph2.add_text(project_name)
    ...
    run_paragraph3.add_text(team_name)
    ...
    content1 = doc.add_paragraph(first_topic)
    ...
    response = chat_completion(f'guess what my data is about {column_names}')
...
def ConvertDataToDataFrame(data,cursor):
